                ...
                <div className="mb-4">
                    <ReactMarkdown 
                        ...
                        components={{
                            ...
                            pre: ({ children }) => <pre className="bg-gray-300 p-2 rounded text-xs overflow-x-auto">{children}</pre>,
                        }}
                    >
                        {question}
                    </ReactMarkdown>
                            ...
                            <div className="mt-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                <ReactMarkdown 
                                    ...
                                    components={{
                                        ...
                                        ol: ({ children }) => <ol className="list-decimal list-inside mb-2 space-y-1">{children}</ol>,
                                        li: ({ children }) => <li className="text-sm">{children}</li>,
                                        code: ({ children }) => <code className="bg-blue-200 px-1 py-0.5 rounded text-xs">{children}</code>,
                                    }}
                                >
                                    {explanation}
                                </ReactMarkdown>
                            ...
                            <div className="mt-2 p-3 bg-green-50 rounded-lg border border-green-200">
                                <ReactMarkdown 
                                    ...
                                    components={{
                                        ...
                                        ol: ({ children }) => <ol className="list-decimal list-inside mb-2 space-y-1">{children}</ol>,
                                        li: ({ children }) => <li className="text-sm">{children}</li>,
                                        code: ({ children }) => <code className="bg-green-200 px-1 py-0.5 rounded text-xs">{children}</code>,
                                    }}
                                >
                                    {solution}
                                </ReactMarkdown>
